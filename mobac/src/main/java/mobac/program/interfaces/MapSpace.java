...
public interface MapSpace {
     ...
     * specified as angular distance, therefore this method works with all length unit systems (e.g. metric, imperial,
     * ...).
     *
     * @param startX      x-coordinate of start point
     * @param y           y-coordinate specifying the latitude to "walk" on
     * @param zoom
     ...
     *
     * @param zoom
     * @param y     y-coordinate specifying the latitude
