...
public class EnvironmentSetup {
	...
	/**
	 * In case the <tt>mapsources</tt> directory has been moved by configuration
	 * (directories.ini or settings.xml) we need to copy the existing map packs into
	...
	/**
	 * Note: This method has be be called before {@link Settings#loadOrQuit()}.
	 * Therefore no localization is available at this point.
	 */
