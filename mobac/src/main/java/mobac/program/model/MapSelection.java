...
public class MapSelection {
	...
	/**
	 * Returns the top left tile x- and y-tile-number (minimum) of the selected area
	 * marked by the {@link MapSelection}.
	 *
	 * @param aZoomlevel
	...
	/**
	 * Returns the top left tile x- and y-tile-coordinate (minimum) of the selected
	...
	/**
	 * Returns the bottom right tile x- and y-tile-number (minimum) of the selected
	 * area marked by the {@link MapSelection}.
	 *
	 * @param aZoomlevel
	 * @return tile number [0..2<sup>zoom</sup>]
	...
	/**
	 * Return the amount of tiles for the current selection in the specified zoom
	 * level.
	 *
	 * @param zoom
