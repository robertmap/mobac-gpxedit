...
public class MapPolygon extends Map {
	...
	public MapPolygon(Layer layer, String name, MapSource mapSource, int zoom, Polygon polygon,
		...
		// Make sure the minimum tile coordinate starts/ends on the edge of a tile from
		// the map source
	...
	public String getToolTip() {
		...
		sw.write(String.format(I18nUtils.localizedStringForKey("lp_atlas_info_map_area_start"), tl, minTileCoordinate.x,
				minTileCoordinate.y));
		sw.write(String.format(I18nUtils.localizedStringForKey("lp_atlas_info_map_area_end"), br, maxTileCoordinate.x,
				maxTileCoordinate.y));
