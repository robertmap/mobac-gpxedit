...
public class RmpTools {
	...
	/**
	 * Writes the given string into the stream. The string is written with a fixed
	 * length. If the length is longer than the string, then 00 bytes are written
	 *
	 * @param stream
	 *            stream to write to
	 * @param str
	...
	/**
	 * Build an image name from a filename. The image name is the name of the file
	 * without path and extension . The length of the name is limited to 8 chars. We
	 * use only 6 chars, so we can use 99 images
	 */
