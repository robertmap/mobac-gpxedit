 ...
 *
 *         The original GEMFFile.java from above has been reduced to the
 *         functionality of writing a GEMF archive, as reading the archive seems
 *         not to be necessary.
 *
 * @author M. Reiter
 *
...
public class GEMFFileCreator {
	 ...
	 *
	 * @param pLocation String object representing path to first GEMF archive file.
	 * Additional files (if archive size exceeds FILE_SIZE_LIMIT will be created
	 * with numerical suffixes, eg: test.gemf-1, test.gemf-2.
	 *
	 * @param pSourceFolders Each specified folder will be imported into the GEMF
	 * archive as a seperate source. The name of the folder will be the name of the
	 * source in the archive.
	 */
	public GEMFFileCreator(final String pLocation, final List<File> pSourceFolders, Logger log) throws IOException {
