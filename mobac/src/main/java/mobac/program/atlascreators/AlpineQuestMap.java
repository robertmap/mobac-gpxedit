 ...
 * <p>
 * AQM format pack tiles in a unique file using the FlatPack format. Supports
 * multi-layers, tile resizing.
 *
 * @author Camille
 */
...
public class AlpineQuestMap extends AtlasCreator {
	...
	public boolean testMapSource(final MapSource mapSource) {
		...
		return (mapSpace instanceof MercatorPower2MapSpace) && (ProjectionCategory.SPHERE.equals(projectionCategory)
