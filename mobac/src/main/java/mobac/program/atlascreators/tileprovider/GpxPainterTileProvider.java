 ...
 * Incomplete!
 * <p>
 * TODO: Fully implement this class so that the content (points, tracks, ...)
 * can be painted on each tile. If the implementation is complete the
 * {@link GpxPainterTileProvider} can be chained into the tile provider chain
 * after the {@link DownloadedTileProvider} (see AtlasThread line ~348).
 * <p>
