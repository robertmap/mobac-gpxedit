...
public class MagellanRmp extends AtlasCreator {
	...
	protected void createTiles() throws InterruptedException, MapCreationException {
		...
		try (TileImageDataWriter tileWriter = tileWriterBuilder.build()) {
			RmpLayer layer = createLayer(layerImage, layerNum, tileWriter);
	...
	/**
	 * Create a new instance of a TLM file and fill it with the data of a calibrated
	 * image
	 *
	 * @param si
	 ...
	 * @throws IOException
	 */
	public RmpLayer createLayer(MultiImage si, int layer, TileImageDataWriter tileWriter)
		...
		/*
		 * Create the tiles - process works column wise, starting on the top left corner
