	...
	public void mouseClicked(MouseEvent e) {
		if (e.getSource() instanceof JTree) {
			...
			if (userObj instanceof mobac.gui.gpxtree.GpxRootEntry) {
				// Only toggle visibility if click is within the icon bounds (leftmost 0-20px of the row)
	...
	private void showPopup(MouseEvent e) {
		...
		if (selectedPaths != null && selectedPaths.length > 1) {
			...
			if (allWaypoints) {
				...
				copyMove.addActionListener(ev -> {
					...
					for (javax.swing.tree.TreePath path2 : selPaths) {
						Object uo = ((javax.swing.tree.DefaultMutableTreeNode) path2.getLastPathComponent()).getUserObject();
						if (uo instanceof WptEntry) {
							wptsToCopy.add((WptEntry) uo);
							selectedNodes.add((DefaultMutableTreeNode) path2.getLastPathComponent());
						}
					}
					if (wptsToCopy.isEmpty()) return;
					...
					int result = javax.swing.JOptionPane.showConfirmDialog(null, panel, "Copy/Move Waypoint(s)", javax.swing.JOptionPane.OK_CANCEL_OPTION, javax.swing.JOptionPane.PLAIN_MESSAGE);
					...
					if (destRoot == null) {
						...
						if (gpxFiles.size() > 0) panelRef = gpxFiles.get(0).getLayer().getPanel();
			...
			delete.addActionListener(ev -> {
				...
				int answer = javax.swing.JOptionPane.showConfirmDialog(null, I18nUtils.localizedStringForKey("rp_gpx_msg_confim_delete"),
						I18nUtils.localizedStringForKey("rp_gpx_msg_confim_delete_title"), javax.swing.JOptionPane.YES_NO_OPTION,
		...
		JMenuItem properties = new JMenuItem(I18nUtils.localizedStringForKey("rp_gpx_menu_properties"));
		   properties.addActionListener(ev -> {
			   var wpt = wptEntry.getWpt();
			   javax.swing.JDialog dialog = new javax.swing.JDialog((java.awt.Frame) null, I18nUtils.localizedStringForKey("rp_gpx_dialog_waypoint_properties"), true);
			   ...
			   String[] labels = {
				   I18nUtils.localizedStringForKey("rp_gpx_label_name"),
			   ...
			   java.util.function.Function<mobac.data.gpx.gpx11.WptType, String>[] getters = (java.util.function.Function<mobac.data.gpx.gpx11.WptType, String>[]) new java.util.function.Function[] {
				   ...
				   (java.util.function.Function<mobac.data.gpx.gpx11.WptType, String>) (w -> w.getLat() != null ? w.getLat().toPlainString() : ""),
				   (java.util.function.Function<mobac.data.gpx.gpx11.WptType, String>) (w -> w.getLon() != null ? w.getLon().toPlainString() : ""),
				   (java.util.function.Function<mobac.data.gpx.gpx11.WptType, String>) (w -> w.getEle() != null ? w.getEle().toPlainString() : ""),
				   (java.util.function.Function<mobac.data.gpx.gpx11.WptType, String>) (w -> w.getTime() != null ? w.getTime().toString() : ""),
				   ...
				   (java.util.function.Function<mobac.data.gpx.gpx11.WptType, String>) (w -> w.getSat() != null ? w.getSat().toString() : ""),
				   (java.util.function.Function<mobac.data.gpx.gpx11.WptType, String>) (w -> w.getHdop() != null ? w.getHdop().toPlainString() : ""),
				   (java.util.function.Function<mobac.data.gpx.gpx11.WptType, String>) (w -> w.getVdop() != null ? w.getVdop().toPlainString() : ""),
				   (java.util.function.Function<mobac.data.gpx.gpx11.WptType, String>) (w -> w.getPdop() != null ? w.getPdop().toPlainString() : ""),
				   (java.util.function.Function<mobac.data.gpx.gpx11.WptType, String>) (w -> w.getAgeofdgpsdata() != null ? w.getAgeofdgpsdata().toPlainString() : ""),
				   (java.util.function.Function<mobac.data.gpx.gpx11.WptType, String>) (w -> w.getDgpsid() != null ? w.getDgpsid().toString() : "")
			   };
			   ...
			   java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>[] setters = (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>[]) new java.util.function.BiConsumer[] {
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> w.setName(v.isEmpty() ? null : v),
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> { try { w.setLat(v.isEmpty() ? null : new java.math.BigDecimal(v)); } catch (Exception ex) {} },
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> { try { w.setLon(v.isEmpty() ? null : new java.math.BigDecimal(v)); } catch (Exception ex) {} },
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> { try { w.setEle(v.isEmpty() ? null : new java.math.BigDecimal(v)); } catch (Exception ex) {} },
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> { try { if (v.isEmpty()) w.setTime(null); else w.setTime(javax.xml.datatype.DatatypeFactory.newInstance().newXMLGregorianCalendar(v)); } catch (Exception ex) {} },
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> w.setDesc(v.isEmpty() ? null : v),
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> w.setCmt(v.isEmpty() ? null : v),
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> w.setSrc(v.isEmpty() ? null : v),
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> w.setSym(v.isEmpty() ? null : v),
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> w.setType(v.isEmpty() ? null : v),
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> w.setFix(v.isEmpty() ? null : v),
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> { try { w.setSat(v.isEmpty() ? null : new java.math.BigInteger(v)); } catch (Exception ex) {} },
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> { try { w.setHdop(v.isEmpty() ? null : new java.math.BigDecimal(v)); } catch (Exception ex) {} },
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> { try { w.setVdop(v.isEmpty() ? null : new java.math.BigDecimal(v)); } catch (Exception ex) {} },
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> { try { w.setPdop(v.isEmpty() ? null : new java.math.BigDecimal(v)); } catch (Exception ex) {} },
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> { try { w.setAgeofdgpsdata(v.isEmpty() ? null : new java.math.BigDecimal(v)); } catch (Exception ex) {} },
				   (java.util.function.BiConsumer<mobac.data.gpx.gpx11.WptType, String>) (w, v) -> { try { w.setDgpsid(v.isEmpty() ? null : Integer.valueOf(v)); } catch (Exception ex) {} }
			   };
			   ...
			   javax.swing.JButton editBtn = new javax.swing.JButton(I18nUtils.localizedStringForKey("rp_gpx_btn_edit"));
			   javax.swing.JButton saveBtn = new javax.swing.JButton(I18nUtils.localizedStringForKey("rp_gpx_btn_save"));
			   javax.swing.JButton cancelBtn = new javax.swing.JButton(I18nUtils.localizedStringForKey("rp_gpx_btn_cancel"));
			   ...
			   Runnable showAllFields = () -> {
				   ...
				   for (int i = 0; i < labels.length; i++) {
					   ...
					   gbcField.gridx = 1; gbcField.gridy = i;
				   ...
				   gbcBtn.gridx = 0; gbcBtn.gridy = labels.length; gbcBtn.gridwidth = 2;
			   ...
			   // Helper to rebuild panel for view mode (show only non-empty fields, but always show Edit button)
			   Runnable showNonEmptyFields = () -> {
				   ...
				   for (int idx : visibleFieldIndexes) {
					   java.awt.GridBagConstraints gbcLabel = new java.awt.GridBagConstraints();
					   gbcLabel.gridx = 0; gbcLabel.gridy = row2;
					   gbcLabel.insets = new java.awt.Insets(2, 4, 2, 4);
					   gbcLabel.anchor = java.awt.GridBagConstraints.WEST;
					   gbcLabel.fill = java.awt.GridBagConstraints.NONE;
					   gbcLabel.weightx = 0;
					   ...
					   java.awt.GridBagConstraints gbcField = new java.awt.GridBagConstraints();
					   gbcField.gridx = 1; gbcField.gridy = row2;
					   gbcField.insets = new java.awt.Insets(2, 4, 2, 4);
					   gbcField.anchor = java.awt.GridBagConstraints.WEST;
					   gbcField.fill = java.awt.GridBagConstraints.HORIZONTAL;
					   gbcField.weightx = 1.0;
				   ...
				   java.awt.GridBagConstraints gbcBtn = new java.awt.GridBagConstraints();
				   gbcBtn.gridx = 0; gbcBtn.gridy = Math.max(row2, 1); gbcBtn.gridwidth = 2;
				   gbcBtn.insets = new java.awt.Insets(2, 4, 2, 4);
				   gbcBtn.anchor = java.awt.GridBagConstraints.CENTER;
				   panel.add(buttonPanel, gbcBtn);
				   panelRef[0] = panel;
			   ...
			   // Initially, only add non-empty fields and always add button panel at the bottom
			   ...
			   for (int idx : visibleFieldIndexes) {
				   java.awt.GridBagConstraints gbcLabel = new java.awt.GridBagConstraints();
				   gbcLabel.gridx = 0; gbcLabel.gridy = row;
				   gbcLabel.insets = new java.awt.Insets(2, 4, 2, 4);
				   gbcLabel.anchor = java.awt.GridBagConstraints.WEST;
				   gbcLabel.fill = java.awt.GridBagConstraints.NONE;
				   gbcLabel.weightx = 0;
			   ...
			   fieldsRef[0] = fields;
			   java.awt.GridBagConstraints gbcBtn = new java.awt.GridBagConstraints();
			   gbcBtn.gridx = 0; gbcBtn.gridy = Math.max(row, 1); gbcBtn.gridwidth = 2;
			   gbcBtn.insets = new java.awt.Insets(2, 4, 2, 4);
			   gbcBtn.anchor = java.awt.GridBagConstraints.CENTER;
			   panel.add(buttonPanel, gbcBtn);
			   panelRef[0] = panel;
			   ...
			   saveBtn.addActionListener(ev2 -> {
				   for (int i = 0; i < fieldsRef[0].length; i++) if (fieldsRef[0][i] != null) setters[i].accept(wpt, fieldsRef[0][i].getText());
				   ...
				   javax.swing.tree.DefaultTreeModel model = (javax.swing.tree.DefaultTreeModel) ((JTree) tree).getModel();
				   ...
				   if (wptEntry.getLayer() != null && wptEntry.getLayer().getPanel() != null && wptEntry.getLayer().getPanel().getPreviewMap() != null) {
           ...
           copyMove.addActionListener(ev -> {
			   ...
			   for (javax.swing.tree.TreePath path : selPaths) {
				   Object userObj = ((javax.swing.tree.DefaultMutableTreeNode) path.getLastPathComponent()).getUserObject();
			   ...
			   for (int i = 0; i < destNode.getChildCount(); i++) {
				   javax.swing.tree.DefaultMutableTreeNode child = (javax.swing.tree.DefaultMutableTreeNode) destNode.getChildAt(i);
					   ...
					   for (var seg : trk.getTrkseg()) {
						   for (var trkpt : seg.getTrkpt()) {
							   if (trkpt.getLat() != null && trkpt.getLon() != null) {
								   validPoints.add(new Double[]{trkpt.getLat().doubleValue(), trkpt.getLon().doubleValue()});
							   }
						   }
					   }
				   }
				   if (validPoints.isEmpty()) {
					   javax.swing.JOptionPane.showMessageDialog(null, "No valid coordinates found in this GPX file.", "Show on map", javax.swing.JOptionPane.WARNING_MESSAGE);
					   return;
				   }
		...
		// For GPX file (root) nodes, replace 'delete' with 'close file' and handle dirty state
		   if (gpxEntry instanceof GpxRootEntry) {
			   final GpxRootEntry rootEntry = (GpxRootEntry) gpxEntry;
			   ...
			   moveUp.addActionListener(ev -> {
				   ...
				   // Save expanded paths
				   java.util.Enumeration<TreePath> expanded = treeComponent.getExpandedDescendants(new TreePath(treeComponent.getModel().getRoot()));
				   ...
				   if (idx > 0) {
					   javax.swing.tree.DefaultTreeModel model = (javax.swing.tree.DefaultTreeModel) treeComponent.getModel();
			   ...
			   saveFile.addActionListener(ev -> {
				   ...
				   if (rootEntry.getLayer() != null && rootEntry.getLayer().getPanel() != null) {
					   mobac.gui.actions.GpxSave saveAction = new mobac.gui.actions.GpxSave(rootEntry.getLayer().getPanel());
			   ...
			   saveAsFile.addActionListener(ev -> {
				   if (rootEntry.getLayer() != null && rootEntry.getLayer().getPanel() != null) {
					   ...
					   mobac.gui.actions.GpxSave saveAsAction = new mobac.gui.actions.GpxSave(rootEntry.getLayer().getPanel(), true);
			   ...
			   closeFile.addActionListener(ev -> {
				   ...
				   if (proceed) {
					   ...
					   if (nodeToRemove != null) {
						   javax.swing.tree.DefaultTreeModel model = (javax.swing.tree.DefaultTreeModel) ((JTree) e.getSource()).getModel();
