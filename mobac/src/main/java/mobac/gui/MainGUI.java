...
public class MainGUI extends JFrame implements MapEventListener {
	...
	private class WindowDestroyer extends WindowAdapter {
		...
		public void windowClosing(WindowEvent event) {
			...
			if (hasDirty) {
				int result = javax.swing.JOptionPane.showConfirmDialog(MainGUI.this,
						"There are unsaved GPX files. Exit anyway and lose changes?", "Unsaved GPX Files",
						javax.swing.JOptionPane.YES_NO_OPTION, javax.swing.JOptionPane.WARNING_MESSAGE);
				if (result != javax.swing.JOptionPane.YES_OPTION) {
					if (event.getSource() instanceof javax.swing.JFrame) {
						((javax.swing.JFrame) event.getSource())
