...
public class PreviewMap extends JMapViewer {
    ...
    /**
     * @param pStart          x/y tile coordinate of the top left tile regarding the current zoom level
     * @param pEnd            x/y tile coordinate of the bottom right tile regarding the current zoom level
     * @param notifyListeners
     */
