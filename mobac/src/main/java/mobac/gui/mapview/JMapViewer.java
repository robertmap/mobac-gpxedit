...
public class JMapViewer extends JPanel implements TileLoaderListener {
	...
	public void setMapSource(MapSource mapSource) {
		...
		if (mapSource instanceof MapSourceInitialDisplayPosition) {
			MapSourceInitialDisplayPosition vp = (MapSourceInitialDisplayPosition) mapSource;
			if (vp.getInitialDisplayPositionX() != 0) {
				setZoom(mapSource.getMinZoom());
				setDisplayPosition(new Point(0, 0), vp.getInitialDisplayPositionX(), vp.getInitialDisplayPositionY(),
						mapSource.getMinZoom());
			}
		}
