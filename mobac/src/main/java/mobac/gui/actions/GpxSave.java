...
public class GpxSave implements ActionListener {
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (entry == null) {
			JOptionPane.showMessageDialog(null, I18nUtils.localizedStringForKey("rp_gpx_msg_error_save_gpx_file"),
					I18nUtils.localizedStringForKey("rp_gpx_msg_no_select_file"), JOptionPane.ERROR_MESSAGE);
			return;
		}
