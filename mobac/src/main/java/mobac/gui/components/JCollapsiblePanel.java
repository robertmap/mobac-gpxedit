...
public class JCollapsiblePanel extends JPanel {
	...
	/**
	 * Constructs a {@code TitleContainer} that wraps the specified component and
	...
	private void setTitlePanelPreferredSize() {
		...
		titlePanel.setPreferredSize(
				new Dimension(containerPreferredDimension.width, titlePanelPreferredDimension.height));
	}
	...
	/**
	 * Sets the visibility of the title bar. If the title bar is invisible, the user
	 * will not be able to collapse or decollapse the container.
	 *
	 * @param visible
	...
	/**
	 * A {@code MouseListener} that changes the cursor when moved over the title bar
	 * to indicate that it is clickable. Clicking the title bar collapses the
	 * container.
	 */
