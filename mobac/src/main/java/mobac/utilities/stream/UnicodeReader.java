...
/**
 * Generic Unicode text reader, which uses a BOM (Byte Order Mark) to identify the encoding to be used. This also has
 * the side effect of removing the BOM from the input stream (when present).
 *
...
public class UnicodeReader extends Reader {
     ...
     * @param defaultEnc default encoding (used only if BOM is not found) or <code>null</code> to use system default
