...
public class PngConstants {
	...
	/**
	 * Each pixel is a palette index; a PLTE chunk must appear. Allowed bit depths:
	 * 1,2,4,8
	 */
	public static final byte COLOR_PALETTE = 3;

	/**
	 * Each pixel is a grayscale sample, followed by an alpha sample. Allowed bit
	 * depths: 8,16
	 */
	public static final byte COLOR_GRAYSCALE_ALPHA = 4;

	/**
	 * Each pixel is an R,G,B triple, followed by an alpha sample. Allowed bit
	 * depths: 6 8,16
	 */
