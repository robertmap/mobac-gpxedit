...
public class MyMath {
	...
	/**
	 * Divides <code>value</code> by <code>divisor</code> and performs the function
	 * "ceil" on the fractional result. <b>Warning: This method works only with
	 * positive input values!</b>
	 * <p>
	...
	/**
	 * Divides <code>value</code> by <code>divisor</code> and performs the function
	 * "round" on the fractional result. <b>Warning: This method works only with
	 * positive input values!</b>
	 * <p>
	 * Internally only integer arithmetics is used (no floating point arithmetics)
	 * </p>
