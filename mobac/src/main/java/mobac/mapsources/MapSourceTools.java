...
public class MapSourceTools {
	 ...
	 * tile of <code>mapsource</code> regarding the zoom level specified by
	 * <code>zoom</code>.
	 *
	 * @param mapSource
	 * @param zoom
	...
	/**
	 * Calculates latitude and longitude of the upper left corner of the specified
	 * tile of <code>mapspace</code> regarding the zoom level specified by
	 * <code>zoom</code>.
	 *
	 * @param mapSpace
	 * @param zoom
	 ...
	 */
	public static double[] calculateLatLon(MapSpace mapSpace, int zoom, int tilex, int tiley) {
