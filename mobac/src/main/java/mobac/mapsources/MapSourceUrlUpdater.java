...
public class MapSourceUrlUpdater {
	...
	/**
	 * Loads the web page specified by <code>url</code>, parses it into DOM and
	 * extracts the <code>src</code> attribute of all <code>&lt;img&gt;</code>
	 * entities.
	 *
	 * @param url
	 *            http or https url
	...
	/**
	 * Retrieves the text or HTML document on the specified <code>url</code>,
	 * interprets the retrieved data as {@link String} of {@link Charset}
	 * <code>charset</code> and returns this {@link String}.
	 *
	 * @param url
	 * @param charset
	 * @return
