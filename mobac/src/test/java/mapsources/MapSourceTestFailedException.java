...
public class MapSourceTestFailedException extends Exception {
	...
	public MapSourceTestFailedException(MapSource mapSource, String msg, HttpURLConnection conn) throws IOException {
		super(msg);
	...
	public MapSourceTestFailedException(Class<? extends MapSource> mapSourceClass, URL url, int httpResponseCode) {
		super();
