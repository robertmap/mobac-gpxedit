...
public class TestTileServer extends Serve {
	...
	private static final Logger log = LoggerFactory.getLogger(TestTileServer.class);
	...
	public static void main(String[] args) {
		try (FileInputStream fi = new FileInputStream("TestTileServer.properties")) {
			Properties prop = new Properties();
			prop.load(fi);
			System.getProperties().putAll(prop);
		} catch (IOException e) {
			JOptionPane.showMessageDialog(null,
					"Unable to load file DebugTileServer.properties: " + e.getMessage() + "\nUsing default values",
