...
public class MapSourceCapabilityDetector {
	...
	public MapSourceCapabilityDetector(Class<? extends HttpMapSource> mapSourceClass, EastNorthCoordinate coordinate,
			int zoom) throws InstantiationException, IllegalAccessException, IllegalArgumentException,
	...
	public static void main(String[] args) {
		...
		List<MapSourceCapabilityDetector> result = testMapSource("NzTopoMaps", new EastNorthCoordinate());
	...
	public static List<MapSourceCapabilityDetector> testMapSource(HttpMapSource mapSource,
		...
		for (int zoom = mapSource.getMinZoom(); zoom < mapSource.getMaxZoom(); zoom++) {
			MapSourceCapabilityDetector mstd = new MapSourceCapabilityDetector(mapSource, coordinate, zoom);
			mstd.testMapSource();
			result.add(mstd);
			// log.trace(mstd);
		}
