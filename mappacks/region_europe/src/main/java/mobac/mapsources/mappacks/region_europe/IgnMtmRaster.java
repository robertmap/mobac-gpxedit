 ...
 * 
 */
public class IgnMtmRaster extends AbstractHttpMapSource implements MapSourceTextAttribution {

	private static final String BASE_URL = "http://www.ign.es/wmts/mapa-raster?"
			+ "layer=MTN&style=default&tilematrixset=GoogleMapsCompatible&"
			+ "Service=WMTS&Request=GetTile&Version=1.0.0&Format=image%2Fjpeg&";

	public IgnMtmRaster() {
		super("IgnMtmRaster", 1, 17, TileImageType.JPG, TileUpdate.LastModified);
	}
	...
	public String toString() {
		return "IGN MTM raster WMTS (Spain)";
	}
